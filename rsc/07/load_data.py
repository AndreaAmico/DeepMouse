...
def load_data(grid):
    right = pd.read_csv(f'{grid["root_path"][1]}/data/right.txt', header=None).values.tolist()
    left = pd.read_csv(f'{grid["root_path"][1]}/data/left.txt', header=None).values.tolist()
